...
*/
    ...
    class ka {
        constructor() {
            let a = (k.trustedTypes && k.trustedTypes.emptyHTML) || '';
    ...
    function wa(a, b) {
        for (let c = ua(a.m()), d = 0; d < c.length; d++) {
            let e = c[d];
            let f = e.g;
            if (q(b, f)) {
                a.g && delete a.g[e.g];
                ...
                if (e.l) {
                    e = u(b, f);
                    for (let h = 0; h < e.length; h++) va(a, f, g ? e[h].clone() : e[h]);
    ...
    z.prototype.h = function (a, b) {
        if (a.h == 11 || a.h == 10) return b instanceof p ? b : this.g(a.s.prototype.m(), b);
        if (a.h == 14) return typeof b === 'string' && xa.test(b) && ((a = Number(b)), 0 < a) ? a : b;
        if (!a.o) return b;
        a = a.s;
        if (a === String) {
            ...
            a === Number &&
            typeof b === 'string' &&
            (b === 'Infinity' || b === '-Infinity' || b === 'NaN' || xa.test(b))
        )
            return Number(b);
        return b;
    };
    ...
    C.prototype.h = function (a, b) {
        return a.h == 8 ? !!b : z.prototype.h.apply(this, arguments);
    };
...
*/
    ...
    n(I, p);
    let Ba = null;
    let Ca = { ra: 0, qa: 1, pa: 5, oa: 10, na: 20 };
...
*/
    ...
    let Ha = RegExp('[+\uff0b]+');
    let L = RegExp('^[+\uff0b]+');
    let Ia = RegExp('([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])');
    let Ja = RegExp('[+\uff0b0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]');
    let Ka = /[\\\/] *x/;
    let La = RegExp('[^0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9A-Za-z#]+$');
    let Ma = /(?:.*?[A-Za-z]){3}.*/;
    let Na = RegExp(
    ...
    K.prototype.format = function (a, b) {
        ...
        null != e &&
            ...
            w(g, 5),
            (g = w(g, 4)),
            (d = b == 2 && null != g && 0 < g.length ? d.replace(f, e.replace(Sa, g)) : d.replace(f, e)),
            b == 3 &&
                ((d = d.replace(
                    RegExp(
                        '^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+'
    ...
    function R(a, b, c) {
        return c == '001' ? T(a, String(b)) : T(a, c);
    }
    function Q(a) {
        if (!q(a, 2)) return '';
        let b = String(r(a, 2));
    ...
    function V(a, b) {
        let c = a.length;
        return 0 < x(b, 9) && u(b, 9).indexOf(c) == -1 ? !1 : N(w(b, 2), a);
    }
    function ab(a, b) {
        if (b == null) return null;
        let c = w(b, 1);
    ...
    function W(a, b, c, d) {
        let e = U(c, d);
        let f = x(e, 9) == 0 ? u(r(c, 1), 9) : u(e, 9);
        e = u(e, 10);
        if (d == 2)
            if (Xa(U(c, 0)))
                (a = U(c, 1)),
                    Xa(a) &&
                        ((f = f.concat(x(a, 9) == 0 ? u(r(c, 1), 9) : u(a, 9))),
                        f.sort(),
                        e.length == 0 ? (e = u(a, 10)) : ((e = e.concat(u(a, 10))), e.sort()));
    ...
    function db(a, b, c, d, e, f) {
        ...
        if (h.length == 0) g = 20;
            ...
            if (g.search(h) == 0) {
                ...
                l && null != l[1] && 0 < l[1].length && O(l[1], Ea) == '0'
                    ? (g = !1)
        ...
        if (
            ...
            l.lastIndexOf(h, 0) == 0 &&
                ...
                eb(h, c, null),
                (h = h.toString()),
                (!N(l, b.toString()) && N(l, h)) || W(a, b.toString(), c, -1) == 3))
        )
    ...
    function fb(a, b, c, d) {
        ...
        try {
            ...
            if (ca.message == 'Invalid country calling code' && L.test(l)) {
                if (((l = l.replace(L, '')), (h = db(a, l, g, b, d, f)), h == 0)) throw ca;
            } else throw ca;
        }
        0 != h
            ? ((e = S(h)), e != c && (g = R(a, h, e)))
    ...
    function N(a, b) {
        return (a = typeof a === 'string' ? b.match('^(?:' + a + ')$') : b.match(a)) && a[0].length == b.length
            ? !0
            : !1;
    }
    function gb(a) {
    ...
    function lb(a) {
        for (let b = a.j.length, c = 0; c < b; ++c) {
            let d = a.j[c];
            let e = w(d, 1);
            if (a.da == e) return !1;
            let f = a;
            ...
            let l = f;
            g = w(g, 2);
            let A = '999999999999999'.match(h)[0];
    ...
    function mb(a, b) {
        for (var c = [], d = b.length - 3, e = a.j.length, f = 0; f < e; ++f) {
            ...
            x(g, 3) == 0
                ? c.push(a.j[f])
                : ((g = r(g, 3, Math.min(d, x(g, 3) - 1))), b.search(g) == 0 && c.push(a.j[f]));
        }
        a.j = c;
    }
    function nb(a, b) {
        a.s.g(b);
        let c = b;
        Ia.test(c) || (a.s.h.length == 1 && Ha.test(c))
    ...
    function ub(a) {
        for (let b = a.g.toString(), c = a.j.length, d = 0; d < c; ++d) {
            let e = a.j[d];
            let f = w(e, 1);
            if (
                new RegExp('^(?:' + f + ')$').test(b) &&
    ...
    function sb(a) {
        ...
        if (3 <= b.length) {
            for (
                let c = a.ca && a.o.length == 0 && 0 < x(a.l, 20) ? u(a.l, 20) : u(a.l, 19), d = c.length, e = 0;
                e < d;
                ++e
            ) {
                let f = c[e];
                (0 < a.o.length && Ya(w(f, 4)) && !r(f, 6) && !q(f, 5)) ||
                    ((0 != a.o.length || a.ca || Ya(w(f, 4)) || r(f, 6)) && jb.test(w(f, 2)) && a.j.push(f));
            }
            mb(a, b);
            b = ub(a);
    ...
    function rb(a) {
        ...
        else (d = a.g.toString()), (d = d.charAt(0) == '1' && '0' != d.charAt(1) && '1' != d.charAt(1));
        d
    ...
    function pb(a) {
        ...
        a.g.g(b.toString());
        b = S(c);
        b == '001' ? (a.l = T(a.ga, String(c))) : b != a.ka && (a.l = hb(a, b));
        a.h.g(String(c)).g(' ');
        a.o = '';
        return !0;
    }
    ...
    m('intlTelInputUtils.getValidationError', (a, b) => {
        try {
            ...
            return c.message === 'Invalid country calling code'
                ? 1
                : 3 >= a.length ||
                    c.message === 'Phone number too short after IDD' ||
                    c.message === 'The string supplied is too short to be a phone number'
                  ? 2
                  : c.message === 'The string supplied is too long to be a phone number'
                    ? 3
                    : -99;
        }
    });
    m('intlTelInputUtils.isValidNumber', (a, b) => {
        try {
            ...
            let e = w(c, 1);
            let f = R(a, e, d);
            if (f == null || ('001' != d && e != bb(a, d))) var g = !1;
            else {
                let h = Q(c);
                g = -1 != $a(h, f);
            }
