...
const Slider = () => {
    ...
    const slides: ItemProp[] = [
        ...
        },
        {
            ...
            icon: ForClient4,
            text: t(
                'Сотрудничество с K SOLUTIONS могут помочь финансировать развитие новых предприятий и стимулировать инновационную деятельность, как и вашей компании, так и других проектов.'
            ),
        },
        {
